...
itl2 <- readRDS('../data/misc/LCREE_BRES_GVAcurrentprices_combo_2015to2022_MINUS_IMPUTED_RENT.rds') %>% rename(jobcountFT = COUNT) %>% ungroup()
...
greenjobs.percent <- readRDS('../data/misc/greenjobspercent.rds')
...
sectors4plot <- readRDS('../data/misc/itl2_percent_gva_by_sector.rds')
sectors4plot.RANGE <- readRDS('../data/misc/itl2_percent_gva_by_sector_rangebars.rds')  
...
itl2.gvaperjob <- readRDS('../data/misc/itl2_gvaperjob.rds')
...
jobnumbers.table <- readRDS('../data/misc/GVAjobnumberestimates.rds') %>% select(-place)
