...
This report uses **seven visualisations** of ONS and Companies House data to compare the economies of Leeds and Bradford and put them in a national context. There are **links to each of them on the right**, or scroll through them below. (Also, hover over figure citations for previews.) There's also a run-through of highlights of what the data shows in the next section. Open data and code for this report is all [here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/quarto_docs/LeedsBradford_allresults.qmd).

Before the data, here's a quick overview of what this most recent data might suggest, in the context of other reports on the Bradford/Leeds region.

* Analysis of commuter flows repeatedly reaffirms Bradford’s “strong functional relationship with Leeds” with “high flows of young qualified Bradford residents working in Leeds, many in the large global and UK consulting, accounting, insurance and financial services sector companies with presence there” (Metro Dynamics 2017). Though this latest data analysis shows Leeds still has the edge with these service sectors, in the intervening years, Bradford has been converging in the same direction, especially in finance and legal sectors.
* This latest data shows both sector co-movement over time and divergence, suggesting some specialisation and some deeper linkages. Both places have a good mix of larger and micro firms, with “sophisticated supply chains” identified by MD still developing. Sectors connected to learning and innovation appear to be moving toward each other (education, scientific/technical) while Leeds’ business services continue to diverge – though this isn’t true of all services. Bradford’s finance and legal sectors, for example, suggest growth that is likely benefiting from agglomeration across both (also true of other local authorities in West Yorkshire). 
* That picture challenges any simple / stereotypical core/periphery take that says “Leeds is the high value, service focused core city, Bradford is more production / distribution focused”. Productivity analysis does show Leeds has higher per worker output in several sectors, but both are very close across most sectors, and have historically moved in lockstep – with Bradford’s productivity higher in some key sectors like scientific /technical. That sector, and ICT, have also seen productivity grow more than the UK average across both places.
* This integration and level of commute flows have developed despite transport connectivity, not because of it. It has shaped which parts of the two cities have been able to connect the most and thus benefit from linkages (Metro Dynamics 2017 pp.21). Several recent analyses (see e.g. [Stansbury et al 2023](https://www.hks.harvard.edu/centers/mrcbg/publications/awp/awp198)) have reinforced evidence of UK transport constraining core cities and their linked job markets. The Northern Powerhouse Rail assessment’s analysis suggested that better “connection between Leeds, Bradford and Manchester can alone potentially increase productivity by 6%, raise the employment rate by 1.5% and increase gross value added (GVA) in the north by about 8% over 10 years” (Mott McDonald p.4). This data analysis has pointed to the possible deep connections between Bradford and Leeds’ innovation and research systems, as well as their complementary service infrastructure; a step change in transport connectivity could lead to a qualitatively different level of agglomeration built on that, taking both cities beyond the kind of numbers NPR cite. Recent growth evidence in firms (both larger and micro) evident in the Companies House data indicates what direction the region could go in, especially if building on wider 'corridors of opportunity' across West Yorkshire's economy (see Companies House analysis below of growth across the region's five local authorities).
...
* @fig-sectorplot-cp-LB shows how Leeds' and Bradford's economic proportions have changed over time.
