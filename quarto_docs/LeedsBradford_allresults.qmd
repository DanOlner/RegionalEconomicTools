...
## 3A: Same as above from Companies House data, but all firms with fewer than 10 employees
...
## 4: Location quotient change for Leeds and Bradford's broad sectors
...
## 5. Which sectors grew as a proportion of *both* Leeds and Bradford, and by how much? Change between 1998 and 2023 (5 yr moving av) in Leeds and Bradford sectors (2 digit SIC)
...
## 6. In the last decade (2014 to 2023) which sectors in Leeds and Bradford have increased their output significantly more than other places?
