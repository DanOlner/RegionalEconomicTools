...
The industrial strategy drills down below its top level sectors into 'frontier' sectors, usually (but not always) using more granular SIC codes. The plots below break the data down into these frontier and other sectors.

Only industrial strategy sectors with 100+ jobs are shown (average from 2021 to 2023 for BRES, and in the latest accounts for Companies House).
