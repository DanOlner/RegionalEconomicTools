...
**One last thing** - all the code for the Quarto output file is [also online here](https://github.com/DanOlner/RegionalEconomicTools/raw/refs/heads/gh-pages/pipeline.qmd){target="_blank"}, if you want to just get the whole thing rather than piece it together as we go.
