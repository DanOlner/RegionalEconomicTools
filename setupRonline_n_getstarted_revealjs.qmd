...
1. The **middle 'copy raw file' button**: click this and github will stick the whole script onto the clipboard, ready for pasting into an R script, as we did above.
2. The **right-hand 'download raw file' button**: download a copy, and then use the **upload button** at the top of the **files tab** in RStudio to import it.
