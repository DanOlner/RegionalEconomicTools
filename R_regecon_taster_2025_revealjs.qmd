...
* And [this page](https://danolner.github.io/RegionalEconomicTools/regionalgva_n_bres.html){target="_blank"} has easy-access CSVs for all the data types in the regional industry data, including linked jobs data (but I haven't updated to 2023 entirely yet!)
...
* Harmonised regional GVA and jobs data. I've done that [here](https://danolner.github.io/RegionalEconomicTools/regionalgva_n_bres.html) but needs a 2023 update.
