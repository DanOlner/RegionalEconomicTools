---
title: "Using R for regional economic analysis, ONS Local taster session (17th June 2025)"
sidebar: false
code-overflow: wrap
execute:
  echo: true
...
If of interest, code for these functions are [on the github site here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/functions/misc_functions.R){target="_blank"}.
...
Today we're looking at **just one example pulled from the Excel sheet**. If you want any of the other ready-made CSVs, I've pipelined them all [to this webpage](https://danolner.github.io/RegionalEconomicTools/regionalgva_n_bres.html){target="_blank"} for the 2025 data.

If you want code for doing any of those extractions, it's [here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/prepcode/regionalGVA_processing.R){target="_blank"}.
...
* The code for that [is here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/prepcode/regionalGVA_processing.R){target="_blank"} and we run through another example later.
...
* There are a load more examples of using this data for comparing places, doing location quotients etc at my [regional econ tools](https://danolner.github.io/RegionalEconomicTools/){target="_blank"} website (of course produced using R!)
* [This intro](https://danolner.github.io/RegionalEconomicTools/intro_gvajobsdata_in_R.html){target="_blank"} has basic examples, [this digs more](https://danolner.github.io/RegionalEconomicTools/sector_locationquotients_and_proportions.html){target="_blank"} into using LQs to put places in national context, [this looks at](https://danolner.github.io/RegionalEconomicTools/gdp_gaps.html){target="_blank"} ways to see how GVA 'gaps' between places change over time.
...
* Building full pipelines from the data wrangling above can include:
    - Preparing reports in R. [Here's an example](https://danolner.github.io/FirmAnalysis/ONS_business_demography.html){target="_blank"} looking at business dynamism using ONS data.
    - [Using github](https://github.com/DanOlner){target="_blank"} to complete the pipeline by presenting online (e.g. these slides!)
    - Interactives in R e.g. Companies House '[most common sector](https://danolner.github.io/companieshouseopen/maps/companieshouse_modal_SICsection_byemployeecount_minfiftyplus_hex5000.html){target="_blank"}' hexmap; [interactive employment report](https://danolner.github.io/companieshouseopen/reports/companies_house_SY_initialreport_march2025.html){target="_blank"}.
    - Making dashboards using R Shiny e.g. South Yorkshire Companies House employee change [dashboard](https://danolner.shinyapps.io/SY_companieshouse/){target="_blank"}.




## Other things we could cover another time (links to examples)

* Directly accessing NOMIS data in R and harmonising with other sources. Examples: [BRES jobs](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/prepcode/BRES_API_download.R){target="_blank"}. [Good GVA demoninators](https://github.com/DanOlner/ukcompare/blob/master/explore_code/beatty_fothergill_update.R){target="_blank"} like 16-64s or 16+, per filled job, pop count, per hour worked ([example](https://danolner.github.io/ukcompare/plotly/GVA_measures_percentofUKaverage_excluding_LondonOutliers.html) of plotting GVA over each of these). [SICSOC](https://github.com/DanOlner/ukcompare/blob/master/explore_code/sic_soc_explore.R){target="_blank"} industry vs occupation (dashboard example in SICSOC tab [here](https://danolner.shinyapps.io/EconDataDashboard/){target="_blank"}).
* Harmonised regional GVA and jobs data. I've done that [here](https://danolner.github.io/RegionalEconomicTools/regionalgva_n_bres.html) but the GVA/jobs link needs a 2023 update.
...
* Happy to chat - d dot olner at sheffield dot ac dot uk or [message me on LinkedIn](https://www.linkedin.com/in/danolner/){target="_blank"}.
...
knitr::purl(input = "R_regecon_taster_2025_revealjs.qmd", output = "R_regecon_taster_2025_codeextract.R",documentation = 2)
