...
* Building full pipelines from the data wrangling above can include:
    ...
    - Interactive plots and maps in R e.g. Companies House '[most common sector](https://danolner.github.io/companieshouseopen/maps/companieshouse_modal_SICsection_byemployeecount_minfiftyplus_hex5000.html){target="_blank"}' hexmap.
