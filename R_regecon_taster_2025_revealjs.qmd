...
* And here's the link to your own slide copy in the browser again, just in case: `bit.ly/rtasterslides`
...
* These are methods I've been developing working with [SYMCA](https://www.southyorkshire-ca.gov.uk/){target="_blank"} as a [Y-PERN](https://y-pern.org.uk/){target="_blank"} policy fellow, seconded from Sheffield University.
...
* **These slides are an example:** code available [here](https://github.com/DanOlner/RegionalEconomicTools/blob/gh-pages/R_regecon_taster_2025_revealjs.qmd).
...
* I've got **two tabs open I'll move between**: 
    - These slides with the code and links in
    - RStudio, open in posit.cloud. 
