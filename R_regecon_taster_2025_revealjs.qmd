...
* Signpost to next steps if you want to do more. For anyone who does want to continue, **I'd be keen on developing networks between us to collaborate on our capacity building.**
...
* I'll about **how to make reproducible pipelines all the way from data source to outputs**.
* **These slides are an example:** code available here.
...
* If in a workshop, we can take time to fix those problems. Sorry, **we don't have time for that today**.
