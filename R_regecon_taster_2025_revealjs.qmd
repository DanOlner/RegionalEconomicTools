...
We'll be doing a **whistlestop tour** of using R for regional economic analysis of UK data. It's the source we'll run through in the June '25 [ONS Presents taster session](https://www.eventbrite.co.uk/e/ons-local-workshop-using-r-for-regional-economic-analysis-taster-session-tickets-1372930745819){target="_blank"}.
...
* [Create an account at posit.cloud](https://login.posit.cloud/login){target="_blank"} using the 'sign up' box, and then log in. That'll take you to your online workspace.
